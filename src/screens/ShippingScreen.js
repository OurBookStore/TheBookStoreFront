...
const ShippingScreen = ({ history }) => {
  ...
  useEffect(() => {
    console.log("Whe are in shiippuig",addresses);
    // debugger;
    ...
    if (addresses) {
      // setBillingAddressId(addresses[0].addressId);
      setShippingAddressId(addresses.address);
    }
  }, [dispatch]);
  ...
  const deleteAddress = (addressName) => {
    const addressRequestBody = {
      id : userInfo.id,
      address: null
    };
    ...
    // }
    dispatch(deleteAddressAction(addressRequestBody));
  };
                        ...
                        <InputGroup>
                          <Col md={1}>
                            <Form.Check
                              ...
                              checked={addresses.address === shippingAddressId}
                              onChange={(e) => {
                          ...
                          <Col>
                            ...
                            >
                              <p className='m-0'>{addresses.address} </p>
                          ...
                          <Col md={2} className='mr-0 pr-0'>
                            <Button type='button' variant='light' onClick={() => deleteAddress(addresses.address)}>

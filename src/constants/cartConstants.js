...
export const POSITION_ADD_ITEM_REQUEST = 'POSITION_ADD_ITEM_REQUEST';
export const POSITION_ADD_ITEM_SUCCESS = 'POSITION_ADD_ITEM_SUCCESS';
export const POSITION_ADD_ITEM_FAIL = 'POSITION_ADD_ITEM_FAIL';
export const POSITION_ADD_ITEM_RESET = 'POSITION_ADD_ITEM_RESET';

export const POSITION_UPDATE_ITEM_REQUEST = 'POSITION_UPDATE_ITEM_REQUEST';
export const POSITION_UPDATE_ITEM_SUCCESS = 'POSITION_UPDATE_ITEM_SUCCESS';
export const POSITION_UPDATE_ITEM_FAIL = 'POSITION_UPDATE_ITEM_FAIL';
export const POSITION_UPDATE_ITEM_RESET = 'POSITION_UPDATE_ITEM_RESET';
